...
export function loadOrCreateDigitalaxDesigner(address: Address): DigitalaxDesigner {
    let digitalaxDesigner: DigitalaxDesigner | null = DigitalaxDesigner.load(address.toHexString());
