...
} from "../generated/DigitalaxF3MIndex/DigitalaxF3MIndex";

import {
  DigitalaxDesigner,
  DigitalaxF3MCollectionGroup,
  DigitalaxDeveloper,
...
export function handleCollectionGroupAdded(event: CollectionGroupAdded): void {
  ...
  let collectionGroup = new DigitalaxF3MCollectionGroup(
...
export function handleCollectionGroupRemoved(
  ...
  store.remove("DigitalaxF3MCollectionGroup", event.params.sid.toString());
}
...
export function handleCollectionGroupUpdated(
  ...
  let collectionGroupId = event.params.sid;
  let collectionGroup = DigitalaxF3MCollectionGroup.load(
    collectionGroupId.toString()
  );
  if(collectionGroup){
    // let auctions = new Array<string>();
...
export function handleDesignerGroupRemoved(event: DesignerGroupRemoved): void {
  ...
  if(designer){
      ...
      for (let i = 0; i < collectionIds.length; i += 1) {
        ...
        let collection = DigitalaxF3MNFTCollection.load(collectionId.toString());
        if (collection) {
...
export function handleDeveloperGroupRemoved(
  ...
  if(developer){
    ...
    // for (let i = 0; i < collectionIds.length; i += 1) {
    //   let collectionId = collectionIds[i];
    //   let collection = DigitalaxF3MNFTCollection.load(collectionId);
    //   if (collection) {
