...
} from "../generated/PatronIndex/PatronIndex";

import {
    DigitalaxDesigner,
    PatronCollectionGroup,
    DigitalaxDeveloper,
...
export function handleCollectionGroupAdded(event: CollectionGroupAdded): void {
    ...
    let collectionGroup = new PatronCollectionGroup(collectionGroupId.toString());
...
export function handleCollectionGroupRemoved(event: CollectionGroupRemoved): void {
    store.remove("PatronCollectionGroup", event.params.sid.toString());
}

export function handleCollectionGroupUpdated(event: CollectionGroupUpdated): void {
    let collectionGroupId = event.params.sid;
    let collectionGroup = PatronCollectionGroup.load(collectionGroupId.toString());
