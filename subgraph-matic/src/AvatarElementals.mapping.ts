...
import {
  ChildCreated,
  ChildrenCreated,
  AvatarElementals as AvatarElementalsContract,
  TransferBatch,
  TransferSingle,
} from "../generated/AvatarElementals/AvatarElementals";

import { AvatarElemental, GarmentAttribute } from "../generated/schema";
...
export function handleChildCreated(event: ChildCreated): void {
  ...
  let contract = AvatarElementalsContract.bind(event.address);

  let strand = new AvatarElemental(event.params.childId.toString());
