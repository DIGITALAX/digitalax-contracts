...
export function handleGarmentCollectionMinted(event: MintGarmentCollection): void {
    ...
    let collection = new DigitalaxModelCollection(event.params.collectionId.toString());
...
export function handleGarmentCollectionBurned(event: BurnGarmentCollection): void {
    let collection = DigitalaxModelCollection.load(event.params.collectionId.toString());
