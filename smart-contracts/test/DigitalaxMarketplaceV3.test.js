...
const DigitalaxMarketplaceV3 = artifacts.require('DigitalaxMarketplaceV3Mock');
const DigitalaxMarketplaceV3Real = artifacts.require('DigitalaxMarketplaceV3');
...
contract('DigitalaxMarketplaceV3', (accounts) => {
  ...
  describe('createOffer()', async () => {
    ...
    describe('creating using real contract (not mock)', () => {
      it('can successfully create', async () => {
        const marketplaceNew = await DigitalaxMarketplaceV3Real.new();
