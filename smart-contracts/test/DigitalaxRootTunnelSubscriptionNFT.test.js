...
const DFBundle = artifacts.require('DFBundle');
const DFBundleMainnet = artifacts.require('DFBundleMainnet');
const DigitalaxSubscriptionNFT = artifacts.require('DigitalaxSubscriptionNFT');
const DigitalaxSubscriptionNFTMainnet = artifacts.require('DigitalaxSubscriptionNFTMainnet');
const DigitalaxSubscriptionNFTTunnelMock = artifacts.require('DigitalaxSubscriptionNFTTunnelMock');
const DigitalaxSubscriptionFactory = artifacts.require('DigitalaxSubscriptionFactory');
const DigitalaxSubscriptionRootTunnel = artifacts.require('DigitalaxSubscriptionRootTunnel');
const DigitalaxSubscriptionRootTunnelMock = artifacts.require('DigitalaxSubscriptionRootTunnelMock');

contract('DigitalaxSubscriptionRootTunnel', (accounts) => {
  ...
  beforeEach(async () => {
    ...
    this.digitalaxMaterials = await DFBundleMainnet.new(
        'DFBundle',
        'DFB',
    ...
    this.digitalaxMaterialsV2 = await DFBundle.new(
        'DFBundle',
        'DFB',
        this.accessControls.address,
        '0xb5505a6d998549090530911180f38aC5130101c6',
    ...
    this.tokenV2 = await DigitalaxSubscriptionNFTTunnelMock.new();
    ...
    this.token = await DigitalaxSubscriptionNFTMainnet.new();
    ...
    this.garmentFactoryMatic = await DigitalaxSubscriptionFactory.new();
    ...
    this.digitalaxRootTunnel = await DigitalaxSubscriptionRootTunnel.new(
      this.accessControls.address,
        this.token.address,
        this.digitalaxMaterials.address,
        constants.ZERO_ADDRESS,
    ...
    this.digitalaxRootTunnelMock = await DigitalaxSubscriptionRootTunnelMock.new(
      this.accessControls.address,
        this.token.address,
        this.digitalaxMaterials.address,
        constants.ZERO_ADDRESS,
    ...
    await this.digitalaxMaterials.setGarmentNFTApproved(this.token.address, {from: admin});
