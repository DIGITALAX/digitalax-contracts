...
async function main() {
  ...
  const reserve_hoodie_ids = [
    176, 63, 64, 68, 156, 157, 74, 75, 76, 80, 81, 82, 93, 94, 95, 158, 159, 102, 109, 110, 111,
  ...
  for (let i = 0; i < reserve_cap_ids.length; i += 1) {
    ...
    console.log(reserve_cap_ids[i]);
    console.log(reservePrice_cap);
    console.log(`----------------------`);
  }
  for (let i = 0; i < reserve_hoodie_ids.length; i += 1) {
    ...
    console.log(`--Marketplace created for collection--`);
    console.log(reserve_hoodie_ids[i]);
    console.log(reservePrice_hoodie);
    console.log(`----------------------`);
  }
  for (let i = 0; i < reserve_shirt_ids.length; i += 1) {
    ...
    await createOfferTx.wait();
    console.log(`--Marketplace created for collection--`);
    console.log(reserve_shirt_ids[i]);
    console.log(reservePrice_shirt);
    console.log(`----------------------`);
  }
  for (let i = 0; i < reserve_hoodie2_ids.length; i += 1) {
    ...
    console.log(`--Marketplace created for collection--`);
    console.log(reserve_hoodie2_ids[i]);
    console.log(reservePrice_hoodie2);
    console.log(`----------------------`);
  }
}
