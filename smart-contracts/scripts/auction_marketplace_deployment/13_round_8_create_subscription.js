...
async function main() {
  ...
  const collectionUris = [
      ...
      //     collectionId: 1,
      //     rarity: 'Common',
      //     tokendIds: [100001,100002,100003,100004,100005],
      ...
      // },
      {
          ...
          collectionId: 4,
          rarity: 'Semi-Rare',
          tokendIds: [100006,100007,100008,100009,100010,100011],
      ...
      //     collectionId: 3,
      //     rarity: 'Exclusive',
      //     tokendIds: [100012,100013,100014,100015,100016,100017,100018,100019,100020,100021],
