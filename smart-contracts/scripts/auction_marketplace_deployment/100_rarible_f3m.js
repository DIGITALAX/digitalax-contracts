...
async function main() {
  ...
  const ERC721_GARMENT_ADDRESS = "0x32a89d8c7e511bd3c21d9e4e6ef6044033231490";
  ...
  console.log(`ERC721_GARMENT_ADDRESS found [${ERC721_GARMENT_ADDRESS}]`);
   ...
   const price = await client.simplePrice({ids: 'monavale', vs_currencies:'usd'});
    const monaUsdPrice = parseFloat(price.monavale.usd);


  const GARMENT_COLLECTION_ADDRESS = '0x33b97da79fe456d14e4528931c6a013e20b41da8';
  const V3_ADDRESS = '0x019e14e4eb7a9ba47ba48ae7add21e64e008484e';
  ...
  for (let i = FIRST_COLLECTION; i <= LAST_COLLECTION; i++) {
    ...
    priceNum = priceNum / monaUsdPrice;
