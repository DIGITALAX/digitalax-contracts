...
//     mapping (uint256 => uint256) public dailyDecoRevenueSharing; // Deco revenue sharing
...
//         uint256 dailyDecoRevenueSharing,
//         uint256 _day,
//         uint256 _amount
//     );
...
//         require(IERC20(decoToken).allowance(_msgSender(), address(this)) >= _amount, "DigitalaxRewardsV2.depositRevenueSharingRewards: Failed to supply ERC20 Allowance");

//         // Deposit this amount of MONA here
//         require(IERC20(decoToken).transferFrom(
//             address(_msgSender()),
//             address(this),
//             _amount
//         ));
...
//     function getMonaStakedEthTotal() public view returns(uint256) {
//         return nftStaking.stakedEthTotal();
//     }

//     function getMonaDailyAPY() external view returns (uint256) {
