...
import "./DigitalaxSubscriptionNFT.sol";
import "./DFBundle.sol";
 ...
 */
contract DigitalaxSubscriptionFactory is Context, ReentrancyGuard, Initializable {
    ...
    DigitalaxSubscriptionNFT public garmentToken;
    ...
    function initialize (
        DigitalaxSubscriptionNFT _garmentToken,
        DFBundle _materials,
