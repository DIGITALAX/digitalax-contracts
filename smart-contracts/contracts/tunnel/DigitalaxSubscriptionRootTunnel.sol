...
contract DigitalaxSubscriptionRootTunnel is BaseRootTunnel {
    ...
    */
    constructor(DigitalaxAccessControls _accessControls, DigitalaxSubscriptionNFT _nft, DFBundle _materials, address _stateSender) BaseRootTunnel(_accessControls, _stateSender) public {
        nft = _nft;
