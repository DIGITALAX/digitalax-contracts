 ...
 */
contract DigitalaxSubscriptionMarketplace is ReentrancyGuard, BaseRelayRecipient {
    ...
    constructor(
        ...
        require(address(_oracle) != address(0), "DigitalaxSubscriptionMarketplace: Invalid Oracle");
    ...
    function createOffer(
        ...
        require(garmentCollection.getSupply(_garmentCollectionId) > 0, "DigitalaxSubscriptionMarketplace.createOffer: Collection does not exist");
        ...
        require(_maxAmount <= garmentCollection.getSupply(_garmentCollectionId), "DigitalaxSubscriptionMarketplace.createOffer: Invalid Maximum amount");
        // Ensure the start time stamp is valid
        require(_startTimestamp >= _getNow(), "DigitalaxSubscriptionMarketplace.createOffer: Invalid start time");
     ...
     */
    function buyOffer(uint256 _garmentCollectionId, bool _payWithMona) external payable nonReentrant {
        ...
        require(_isFinished(_garmentCollectionId) == false, "DigitalaxSubscriptionMarketplace.buyOffer: Sale has been finished");
        require(lastPurchasedTime[_garmentCollectionId][_msgSender()] <= block.timestamp.sub(cooldown), "DigitalaxSubscriptionMarketplace.buyOffer: Cooldown not reached");
        ...
        require(garmentNft.isApproved(garmentTokenId, address(this)), "DigitalaxSubscriptionMarketplace.buyOffer: offer not approved");
        ...
        if(_payWithMona) {
            ...
            require(IERC20(monaErc20Token).allowance(_msgSender(), address(this)) >= amountOfMonaToTransfer, "DigitalaxSubscriptionMarketplace.buyOffer: Failed to supply ERC20 Allowance");
            ...
            require(!freezeETHPayment, "DigitalaxSubscriptionMarketplace.buyOffer: eth payments currently frozen");

            require(msg.value >= offer.primarySalePrice, "DigitalaxSubscriptionMarketplace.buyOffer: Failed to supply funds");
            ...
            require(platformTransferSuccess, "DigitalaxSubscriptionMarketplace.buyOffer: Failed to send platform fee");
            ...
            require(designerTransferSuccess, "DigitalaxSubscriptionMarketplace.buyOffer: Failed to send the designer their royalties");
        }
    ...
    function togglePaused(uint256 _garmentCollectionId) external {
        ...
        emit PauseToggled(_garmentCollectionId, offer.paused);
    }
    ...
    function toggleFreezeETHPayment() external {
        require(accessControls.hasAdminRole(_msgSender()), "DigitalaxSubscriptionMarketplace.toggleFreezeETHPayment: Sender must be admin");
    ...
    function updateMarketplaceDiscountToPayInErc20(uint256 _garmentCollectionId, uint256 _marketplaceDiscount) external {
        ...
        require(_marketplaceDiscount <= offers[_garmentCollectionId].platformFee, "DigitalaxSubscriptionMarketplace.updateMarketplaceDiscountToPayInErc20: Discount cannot be greater then fee");
    ...
    function updateMarketplacePlatformFee(uint256 _garmentCollectionId, uint256 _platformFee) external {
        ...
        require(_platformFee >= offers[_garmentCollectionId].discountToPayERC20, "DigitalaxSubscriptionMarketplace.updateMarketplacePlatformFee: Discount cannot be greater then fee");
    ...
    function _estimateMonaAmount(uint256 _amountInETH) internal virtual returns (uint256) {
        ...
        require(rateValid, "DigitalaxSubscriptionMarketplace.estimateMonaAmount: Oracle data is invalid");
    ...
    function _createOffer(
        ...
        require(offers[_garmentCollectionId].startTime == 0, "DigitalaxSubscriptionMarketplace.createOffer: Cannot duplicate current offer");
        // Setup the new offer
